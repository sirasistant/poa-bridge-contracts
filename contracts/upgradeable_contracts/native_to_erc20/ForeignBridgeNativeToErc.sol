...
contract ForeignBridgeNativeToErc is EternalStorage, BasicBridge, BasicForeignBridge {
    ...
    function onExecuteMessage(address _recipient, uint256 _value) internal returns(bool) {
